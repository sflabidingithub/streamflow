...
[![Version](https://img.shields.io/badge/version-2.2.2-blue.svg)](https://github.com/sflabidingithub/streamflow/releases)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/sflabidingithub/streamflow/blob/main/LICENSE)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/sflabidingithub/streamflow/blob/main/CONTRIBUTING.md)
[![GitHub Stars](https://img.shields.io/github/stars/sflabidingithub/streamflow?style=social)](https://github.com/sflabidingithub/streamflow/stargazers)
[![GitHub Forks](https://img.shields.io/github/forks/sflabidingithub/streamflow?style=social)](https://github.com/sflabidingithub/streamflow/network/members)
...
```bash
curl -o install.sh https://raw.githubusercontent.com/sflabidingithub/streamflow/main/install.sh && chmod +x install.sh && ./install.sh
```
...
Clone repository:
```bash
git clone https://github.com/sflabidingithub/streamflow
```
...
[![Contributors](https://contrib.rocks/image?repo=sflabidingithub/streamflow)](https://github.com/sflabidingithub/streamflow/graphs/contributors)

## 📄 License

[![MIT License](https://img.shields.io/badge/License-MIT-green.svg)](https://github.com/sflabidingithub/streamflow/blob/main/LICENSE)
